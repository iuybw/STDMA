...
def get_dataloaders_from_index_data(
    ...
    data1['y_train'] = y_train  # 训练集标签
    data1['x_val'] = x_val      # 验证集特征
    data1['y_val'] = y_val      # 验证集标签
    data1['x_test'] = x_test    # 测试集特征
    data1['y_test'] = y_test    # 测试集标签
    return data1
    ...
    # )
    # data_loader = {}
    # data_loader["train_loader"] = trainset_loader
